...
public class CancroDozeService extends Service {
    private static final String TAG = "CancroDozeService";
    ...
    private CancroProximitySensor mSensor;
    ...
    class CancroProximitySensor implements SensorEventListener {
        ...
        public CancroProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "CancroDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new CancroProximitySensor(mContext);
        mWakeLock = mPowerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "CancroDozeWakeLock");
